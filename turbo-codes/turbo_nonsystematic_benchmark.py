...
parser.add_argument('encoder', type=NonsystematicEncoders, choices=list(NonsystematicEncoders))
parser.add_argument('decoder', type=NonsystematicDecoders, choices=list(NonsystematicDecoders))
