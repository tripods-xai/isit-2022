...
parser.add_argument('encoder', type=SystematicEncoders, choices=list(SystematicEncoders), help="The systematic encoder you wish to test against. See paper for more details.")
parser.add_argument('decoder', type=SystematicDecoders, choices=list(SystematicDecoders), help="The kind of BCJR decoder to use. 'basic' is a traditional BCJR decoder, and 'hazzys' is a systematic code specific decoder that slightly improves performance.")
